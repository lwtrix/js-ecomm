  ...
  return layout({
    ...
    <div class="col-lg-5 col-12 mx-auto mt-5">
      ...
      <form method="POST">
        ...
        <div class="mb-3">
          <label for="passwordConfirmationField" class="form-label">Password confirmation</label>
            <div class="input-group has-validation">
              <input name="passwordConfirmation" type="password" class="form-control ${getError(errors, 'passwordConfirmation') ? "is-invalid" : ""}" id="passwordConfirmationField" aria-describedby="passwordConfirmationFieldFeedback">
              <div id="passwordConfirmationFieldFeedback" class="invalid-feedback">
